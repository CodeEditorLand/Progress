...
The codespace is a VSCode development environment in the cloud. Once the
Codespace is created, start Data Formuator with the following steps:

- A toast about port forwarding will appear, click the **Open in Browser**
  button.
